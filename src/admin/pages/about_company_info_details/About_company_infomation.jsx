...
const BASE_URL = 'http://localhost:5000/add_about_information_data/';
 
class about_company_information extends Component {
constructor(props) {
...
export default about_company_information;
