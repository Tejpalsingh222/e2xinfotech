import "./ourblogdata.scss";
import { DataGrid } from "@mui/x-data-grid";
import { userColumns } from "../../ourblogdata";
...
const Ourblogdata = () => {
  ...
  const handleDelete = (id) => {
    ...
    const responseDel = fetch(`http://localhost:5000/delete-our-blog/${id}`, {
      method: "get",
    }).then((response) => {
  ...
  const handleEdit = (id) => {
    navigate("/dashboard/our_blog_page_edit/" + id);
  }
  ...
  return (
    <div className="datatable">
      <div className="datatableTitle">
        Show Services
        <Link to="/dashboard/our_blog_add/" className="link">
          Add New Blog
        </Link>
      </div>
      <DataGrid
