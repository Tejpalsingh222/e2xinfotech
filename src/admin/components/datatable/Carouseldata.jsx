...
import { userColumns } from "../../carouseldata";
...
const Carouseldata = () => {
  ...
  const handleEdit = (id) => {
    navigate("/dashbaord/carousel_edit/" + id);
  }
        ...
        return (
          <div className="cellAction">
            ...
            {/* <div
              ...
              onClick={() => updateButton(params.row.carousel_id)}
            >
              Active
            </div> */}
          </div>
  ...
  return (
    <div className="datatable">
      <div className="datatableTitle">
        company History
        <Link to="/dashboard/carousel_add" className="link">
